...
public class GrepApplication implements Grep {
	 ...
	 * 
	 * @return A StringBuilder object that holds the contents read from the
	 *         stdin specified.
	 */
	 ...
	 * 
	 * @return A String containing all lines within input stream that contains
	 ...
	 *             is not supported.
	 * 
	 * @return A String containing all lines within the file(s) that contain the
	 *         specified regex pattern delimited by a newline character
	 */
