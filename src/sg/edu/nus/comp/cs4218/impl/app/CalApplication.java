...
/**
 * The cal command prints the calendar of the month or year if it is specified,
 * else only the current month is shown
 * 
 * <p>
 ...
 * <dt>MONTH</dt>
 * <dd>the month to display, if no month and year is specified, display current
 * month.</dd>
 * <dt>YEAR</dt>
 * <dd>the year to display, if no year and month is specified, display current
 * month.</dd>
 * </dl>
 * </p>
 */
public class CalApplication implements Cal {
	 ...
	 * @param stdout
	 *            An OutputStream. Calendar of the specified options will be
	 *            output
	 * @throws CalException
	 ...
	 * 
	 * @param yearStr
	 *            Specifies the year as a string
	 */
	 ...
	 * 
	 * @param args
	 *            String array containing command and arguments to print the
	...
	public String printCal(String args) {
		...
		calOutput.append(printMonthYear(currMonth.getMonthValue(), currMonth.getYear())).append(LINE_SEPARATOR)
				.append(printDaysHeader(false)).append(LINE_SEPARATOR).append(printDaysOfMonth(currMonth, false));
	 ...
	 * 
	 * @param args
	 *            String array containing command and arguments
	 */
	public String printCalWithMondayFirst(String args) {
		...
		calOutput.append(printMonthYear(currMonth.getMonthValue(), currMonth.getYear())).append(System.lineSeparator())
				.append(printDaysHeader(true)).append(LINE_SEPARATOR).append(printDaysOfMonth(currMonth, true));
	 ...
	 * @param
	 * @param isMon
	 *            specifies if the header starts with Monday
	 */
					...
					for (int i = 0; i < (7 - counters[month]); i++) {
						if ((i + 1) == (7 - counters[month])) {
							...
							if ((month + 1) != months.length) {
								...
								if (days[0] <= daysInMonths[0] || days[1] <= daysInMonths[1]
										|| days[2] <= daysInMonths[2]) {
									cal.append(System.lineSeparator());
								}
							}
	 ...
	 * 
	 * @param currMonth
	 *            specifies a LocalDate for the first day of the month
	 * @param isMon
	 *            specifies whether the month calendar starts with Mon
	 */
	 ...
	 * 
	 * @param isMon
	 *            boolean representing whether Monday starts first
	 * @param
	 */
	 ...
	 * 
	 * @param year
	 *            specifies the year to print for the header
	 */
	 ...
	 * 
	 * @param months
	 *            specifies the months to return in a row
	 */
