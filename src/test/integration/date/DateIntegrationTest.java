...
public class DateIntegrationTest {
	...
	public void testWithEcho() throws AbstractApplicationException, ShellException {
		...
		assertEquals(DEFAULT_DATE_FORMAT.format(cal.getTime()).toString() + LINE_SEPARATOR + "hi" + LINE_SEPARATOR,
				output);
	}
	...
	public void testWithEchoCmdSub() throws AbstractApplicationException, ShellException {
		...
		Calendar cal = Calendar.getInstance();
		SimpleDateFormat DEFAULT_DATE_FORMAT = new SimpleDateFormat("EEE MMM dd HH:mm:ss zzz yyyy");
		assertEquals(DEFAULT_DATE_FORMAT.format(cal.getTime()).toString() + LINE_SEPARATOR
				+ DEFAULT_DATE_FORMAT.format(cal.getTime()).toString() + LINE_SEPARATOR, output);
	}
	...
	public void testWithCd() throws AbstractApplicationException, ShellException {
		...
		Calendar cal = Calendar.getInstance();
		SimpleDateFormat DEFAULT_DATE_FORMAT = new SimpleDateFormat("EEE MMM dd HH:mm:ss zzz yyyy");
		assertEquals(DEFAULT_DATE_FORMAT.format(cal.getTime()).toString() + LINE_SEPARATOR + LINE_SEPARATOR
				+ CURRENT_DIRECTORY + LINE_SEPARATOR, output);
	}
	...
	public void testWithPwd() throws AbstractApplicationException, ShellException {
		...
		Calendar cal = Calendar.getInstance();
		SimpleDateFormat DEFAULT_DATE_FORMAT = new SimpleDateFormat("EEE MMM dd HH:mm:ss zzz yyyy");
		assertEquals(DEFAULT_DATE_FORMAT.format(cal.getTime()).toString() + LINE_SEPARATOR + CURRENT_DIRECTORY
	...
	public void testWithCal() throws AbstractApplicationException, ShellException {
		...
		assertEquals(DEFAULT_DATE_FORMAT.format(cal.getTime()).toString() + LINE_SEPARATOR + expectedCalendar
				+ LINE_SEPARATOR, output);
	}
	...
	public void testWithSed() throws AbstractApplicationException, ShellException {
		...
		Calendar cal = Calendar.getInstance();
		SimpleDateFormat DEFAULT_DATE_FORMAT = new SimpleDateFormat("EEE MMM dd HH:mm:ss zzz yyyy");
		assertEquals(DEFAULT_DATE_FORMAT.format(cal.getTime()).toString() + "abc" + LINE_SEPARATOR + LINE_SEPARATOR,
				output);
	}
	...
	public void testWithWc() throws AbstractApplicationException, ShellException {
		...
		SimpleDateFormat DEFAULT_DATE_FORMAT = new SimpleDateFormat("EEE MMM dd HH:mm:ss zzz yyyy");
		assertEquals(
				DEFAULT_DATE_FORMAT.format(cal.getTime()).toString() + LINE_SEPARATOR + "       1" + LINE_SEPARATOR,
				output);
	}
