...
public class CdIntegrationTest {
    ...
    public void testCdWithWc() throws AbstractApplicationException, ShellException {
        ...
        String fileContents = "12" + NEW_LINE
                            + "`Echo hello > " + ABSOLUTE_TEST_DIRECTORY_TWO + PATH_SEPARATOR + "in; cal`" + NEW_LINE
                            + "8122" + NEW_LINE
                            + "300000" + NEW_LINE
                            + "-36" + NEW_LINE
                            + "37" + NEW_LINE
                            ...
                            + "0" + NEW_LINE
                            + "'21000'" + NEW_LINE
                            + "`cd '" + ABSOLUTE_TEST_DIRECTORY_ONE + "'; cat *i`" + NEW_LINE
                            + "10" + NEW_LINE
                            + "-212" + NEW_LINE
                            + "200" + NEW_LINE
                            + "2100" + NEW_LINE
    ...
    public void testCdWithSed() throws AbstractApplicationException, ShellException {
        ...
        String command = "cd " + ABSOLUTE_TEST_DIRECTORY_TWO + PATH_SEPARATOR + "..; sed s/cake/food/ *" 
                        + COMMON_TEST_DIRECTORY_PREFIX + "*" + PATH_SEPARATOR + Symbol.CURRENT_DIR_S + PATH_SEPARATOR 
                        + "*.tx*";
        
        String fileContentsOne = "There is cake at the end of this level" + NEW_LINE
                                + "All this cake is making me hungry for cake" + NEW_LINE
                                + "cake is what some people live for" + NEW_LINE
                                + "Without cake there is nothing";
        String fileContentsTwo = "Cake is bought for everyone" + NEW_LINE
                               ...
                               + "Prepare yourself with some cake armour and cake" + NEW_LINE
                               + "cake is the name of the cake monster" + NEW_LINE
                               + "take care and may ...." + NEW_LINE;
        ...
        String expected = NEW_LINE 
                        + "Cake is bought for everyone" + NEW_LINE
                        ...
                        + "Prepare yourself with some food armour and cake" + NEW_LINE
                        + "food is the name of the cake monster" + NEW_LINE
                        + "take care and may ...." + NEW_LINE
                        + NEW_LINE;
    ...
    public void testCdWithGrep() throws AbstractApplicationException, ShellException {
        ...
        String fileContentsOne = "over the moon moon the over" + NEW_LINE
                               + "ove\"over the moon\" moon \"over the moon\"" + NEW_LINE
                               + "     \t\"over the moon" + NEW_LINE
                               + NEW_LINE
                               + "   over the moon\" over the moon\"  " + NEW_LINE
                               + " 'over the moon' moon \"over the moon " + NEW_LINE
                               + " '\"over the moon\"'";
        
        String fileContentsTwo = "moon \"over the moon\" the over" + NEW_LINE
                               + "moon the '\"over the moon\"' \"over the moon\"" + NEW_LINE
                               + "moo says the cow over the moon 'over the moon'" + NEW_LINE
                               + "  overthemoon  'over the moon'" + NEW_LINE
                               + NEW_LINE;
        ...
        String expected = NEW_LINE
                        + ABSOLUTE_TEST_DIRECTORY_ONE + PATH_SEPARATOR + "in.txt: " + "ove\"over the moon\" moon \"over the moon\"" + NEW_LINE
                        + ABSOLUTE_TEST_DIRECTORY_ONE + PATH_SEPARATOR + "in.txt: " + " '\"over the moon\"'" + NEW_LINE
                        + ABSOLUTE_TEST_DIRECTORY_TWO + PATH_SEPARATOR + "in: " + "moon \"over the moon\" the over" + NEW_LINE
                        + ABSOLUTE_TEST_DIRECTORY_TWO + PATH_SEPARATOR + "in: " + "moon the '\"over the moon\"' \"over the moon\"" + NEW_LINE;
    ...
    public void testCdWithTail() throws AbstractApplicationException, ShellException {
        ...
        String fileContents = "2" + NEW_LINE
                            + "3" + NEW_LINE
                            + NEW_LINE
                            + "4" + NEW_LINE;
    ...
    public void testCdWithEcho() throws AbstractApplicationException, ShellException {
        ...
        String command = "cd " + ABSOLUTE_TEST_DIRECTORY_THREE + "| echo .." + PATH_SEPARATOR + COMMON_TEST_DIRECTORY_PREFIX 
                         + "*" + PATH_SEPARATOR + "in*";
        ...
        String expected = ABSOLUTE_TEST_DIRECTORY_ONE + PATH_SEPARATOR + "in.txt " + ABSOLUTE_TEST_DIRECTORY_TWO + PATH_SEPARATOR 
                          + "in" + NEW_LINE;
