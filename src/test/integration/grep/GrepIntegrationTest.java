...
public class GrepIntegrationTest {
	...
	private static final String RELATIVE_INPUT_DIR = "src" + PATH_SEPARATOR + "test" + PATH_SEPARATOR + "integration"
			+ PATH_SEPARATOR + "grep" + PATH_SEPARATOR + "input" + PATH_SEPARATOR;
	private static final String RELATIVE_EXP_DIR = "src" + PATH_SEPARATOR + "test" + PATH_SEPARATOR + "integration"
			+ PATH_SEPARATOR + "grep" + PATH_SEPARATOR + "expected" + PATH_SEPARATOR; 
	...
	public void testIntegrateNonStdinApps() throws AbstractApplicationException, ShellException{
		...
		String command = "grep that " + RELATIVE_STRANGER1 + "; cd " + RELATIVE_INPUT_DIR + "; pwd; date";
		String expected = "If you say that you are mine" + LINE_SEPARATOR + LINE_SEPARATOR
				+ Environment.currentDirectory + PATH_SEPARATOR + RELATIVE_INPUT_DIR.substring(0, RELATIVE_INPUT_DIR.length() -1) + LINE_SEPARATOR
	...
	public void testIntegrateCat() throws AbstractApplicationException, ShellException{
		...
		String expected = Environment.getAbsPath(RELATIVE_TOTO1) + ": The moonlit wings reflect the stars that guide me towards salvation" + LINE_SEPARATOR
				 + Environment.getAbsPath(RELATIVE_TOTO2) + ": There's nothing that a hundred men or more could ever do" + LINE_SEPARATOR
				 + Environment.getAbsPath(RELATIVE_STRANGER1) + ": If you say that you are mine" + LINE_SEPARATOR;
		String output = shell.parseAndEvaluate(command);
		assertEquals(expected, output);
	}	
	...
	public void testIntegrateHead() throws AbstractApplicationException, ShellException{
		...
		String expected = Environment.getAbsPath(RELATIVE_RICK1) + ": Your heart's been aching but you're too shy to say it" + LINE_SEPARATOR
				 + Environment.getAbsPath(RELATIVE_RICK2) + ": Never gonna give you up" + LINE_SEPARATOR
				 + Environment.getAbsPath(RELATIVE_RICK2) + ": Never gonna let you down" + LINE_SEPARATOR
				 + Environment.getAbsPath(RELATIVE_RICK2) + ": Never gonna run around and desert you" + LINE_SEPARATOR
				 + Environment.getAbsPath(RELATIVE_RICK2) + ": Never gonna make you cry" + LINE_SEPARATOR
				 + Environment.getAbsPath(RELATIVE_RICK2) + ": Never gonna tell a lie and hurt you" + LINE_SEPARATOR;
		String output = shell.parseAndEvaluate(command);
		assertEquals(expected, output);
	}	
	...
	public void testIntegrateTail() throws AbstractApplicationException, ShellException{
		...
		String expected = Environment.getAbsPath(RELATIVE_TOTO2) + ": It's gonna take a lot to drag me away from you" + LINE_SEPARATOR;
		String output = shell.parseAndEvaluate(command);
		assertEquals(expected, output);
	}
	
	@Test
	public void testIntegrateCal() throws AbstractApplicationException, ShellException, IOException{
		String command = "grep Never " + RELATIVE_RICK2 + "; cal";
		String expected = "Never gonna give you up" + LINE_SEPARATOR
				 ...
				 + "Never gonna say goodbye" + LINE_SEPARATOR
				 + "Never gonna tell a lie and hurt you" + LINE_SEPARATOR;
		expected = expected + new String(Files.readAllBytes(Paths.get(RELATIVE_EXP_DIR + "currentMonth"))) + LINE_SEPARATOR;
		String output = shell.parseAndEvaluate(command);
		assertEquals(expected, output);
	}
	...
	public void testIntegrateSort() throws AbstractApplicationException, ShellException{
		...
		String expected = Environment.getAbsPath(RELATIVE_STRANGER1) + ": If you say that you are mine" + LINE_SEPARATOR
				 + Environment.getAbsPath(RELATIVE_TOTO1) + ": The moonlit wings reflect the stars that guide me towards salvation" + LINE_SEPARATOR
				 + Environment.getAbsPath(RELATIVE_TOTO2) + ": There's nothing that a hundred men or more could ever do" + LINE_SEPARATOR;
		String output = shell.parseAndEvaluate(command);
		assertEquals(expected, output);
	}
	...
	public void testIntegrateSed() throws AbstractApplicationException, ShellException{
		...
		String expected = Environment.getAbsPath(RELATIVE_TOTO1) + ": The moonlit wings reflect the stars this guide me towards salvation" + LINE_SEPARATOR
				 + Environment.getAbsPath(RELATIVE_TOTO2) + ": There's nothing this a hundred men or more could ever do" + LINE_SEPARATOR
				 + Environment.getAbsPath(RELATIVE_STRANGER1) + ": If you say this you are mine" + LINE_SEPARATOR;
		String output = shell.parseAndEvaluate(command);
		assertEquals(expected, output);
	}
