...
public class CatIntegrationTest {
	...
	public void testIntegrateEcho() throws AbstractApplicationException, ShellException, IOException{
		String command = "cat `echo \"" + RELATIVE_RICK1 + " " +
				RELATIVE_RICK2 + " " +
				RELATIVE_TOTO1 + " " +
				RELATIVE_TOTO2 + " " +
				RELATIVE_STRANGER1 + "\"`";
	...
	public void testIntegrateEcho2() throws AbstractApplicationException, ShellException{
		...
		String expected = RELATIVE_RICK1 + LINE_SEPARATOR
				+ RELATIVE_RICK2 + LINE_SEPARATOR
				+ RELATIVE_TOTO1 + LINE_SEPARATOR
	...
	public void testNonSdinApps() throws AbstractApplicationException, ShellException{
		...
		String expected = "Never gonna give you up" + LINE_SEPARATOR 
					...
					+ "Never gonna tell a lie and hurt you"+ LINE_SEPARATOR + LINE_SEPARATOR 
	...
	public void testIntegrateSed() throws AbstractApplicationException, ShellException{
		...
		String expected = "Always gonna give you up" + LINE_SEPARATOR 
				+ "Always gonna let you down" + LINE_SEPARATOR
				+ "Always gonna run around and desert you" + LINE_SEPARATOR
				+ "Always gonna make you cry" + LINE_SEPARATOR
				+ "Always gonna say goodbye" + LINE_SEPARATOR
				+ "Always gonna tell a lie and hurt you"+ LINE_SEPARATOR ;
		String actual = shell.parseAndEvaluate(command);
		assertEquals(expected, actual);		
	}
