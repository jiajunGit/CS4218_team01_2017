...
private static final String RELATIVE_TEST_DIRECTORY = "src" + PATH_SEPARATOR + "test" + PATH_SEPARATOR + "calendar" + PATH_SEPARATOR;
	...
	public void testPrintCalWithMondayFirst(){
		...
		CalApplication cal = new CalApplication();
		try {
			expectedCalendar = new String (Files.readAllBytes(Paths.get(RELATIVE_TEST_DIRECTORY + "currentMonthMonday")));
		} catch (IOException e) {
			System.out.println(e);
		}
